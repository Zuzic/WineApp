...
public enum Asset {
  public enum Colors {
    public static let accents = ColorAsset(name: "Accents")
    public static let button = ColorAsset(name: "Button")
    public static let elementsPrimary = ColorAsset(name: "Elements.Primary ")
    public static let elementsSecondary = ColorAsset(name: "Elements.Secondary")
    public static let surface = ColorAsset(name: "Surface")
    public static let textBodyPrimary = ColorAsset(name: "Text.Body.Primary")
    public static let textHeader = ColorAsset(name: "Text.Header")
